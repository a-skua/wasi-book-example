...
#[link_section = "component-type:wit-bindgen:0.25.0:cli-command:encoded world"]
#[doc(hidden)]
...
\x01!component:cli-command/cli-command\x04\0\x0b\x11\x01\0\x0bcli-command\x03\0\0\
